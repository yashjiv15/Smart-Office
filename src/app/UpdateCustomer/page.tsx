...
import { updateCustomer,UpdateCustomerData } from '../../apiService'; // Import the updated API function
...
const validate = (fieldName: keyof FormValues, value: string | undefined): string | undefined => {
...
const UpdateCustomer = () => {
  ...
  useEffect(() => {
    ...
    if (searchParams) {
      const userQuery = searchParams.get('customer');
      if (userQuery) {
  ...
  <div className="-mx-3 flex flex-wrap">
    {[
      ...
      { name: 'spoc_name', label: 'Specific Point of Contact Name', placeholder: 'Enter Your SPOC Name', icon: 'fas fa-user' },
      { name: 'spoc_mobile', label: 'Specific Point of Contact Mobile Number', placeholder: 'Enter SPOC Mobile Number', icon: 'fas fa-phone' },
